...
<body>
    ...
    <div class="button-container">
        ...
        <a class="button" href="ChooseCourse.jsp">
            ...
            <span class="button__text">Choose Course</span>
        ...
        <a class="button" href="CheckMarks.jsp">

            <div class="button__line"></div>

            <div class="button__line"></div>

            <span class="button__text">Check Marks</span>
        ...
        <a class="button" href="StudChangePass.html">
