...
<body>
    ...
    <h1>Professor_Interface</h1>   

    <div class="button-container">

        <a class="button" href="CheckStud.jsp">

            <div class="button__line"></div>

            <div class="button__line"></div>

            <span class="button__text">Check Students</span>
        ...
        <a class="button" href="givemarks.jsp">

            <div class="button__line"></div>

            <div class="button__line"></div>

            <span class="button__text">Give Marks</span>
    ...
    <div>
        ...
        <a class="button" href="ProfChangePass.html">
